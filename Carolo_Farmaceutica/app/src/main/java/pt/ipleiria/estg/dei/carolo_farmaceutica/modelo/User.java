...
public class User {
    ...
    public User(int id, int status, int created_at, int updated_at, String username, String auth_key, String password_hash, String password_reset_token, String email, String verification_token) {
        this.id = id;
        this.status = status;
